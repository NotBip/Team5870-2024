...
/**
 * This command is responsible for slightly nudging the robot to the back to help align it. 
 */
public class NudgeBack extends Command {
    ...
    @Override
    public void execute() {
        // Slightly moving the robot to the back using chassis speeds and then converting them to output for the modules. 
