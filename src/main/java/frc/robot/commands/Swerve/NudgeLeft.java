...
/**
 * This command is responsible for slightly nudging the robot to the left to help align it. 
 */
public class NudgeLeft extends Command {
    ...
    @Override
    public void execute() {
        // Slightly moving the robot to the left using chassis speeds and then converting them to output for the modules. 
