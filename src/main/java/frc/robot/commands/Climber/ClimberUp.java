...
/**
 * This command is responsible for moving the climber up at a constants speed of .20 (Speed is recommended to be below .4)
 */
public class ClimberUp extends Command {
    ...
    @Override
    public void execute() {
        climber.moveArmControllable(0.20); // Sets the climber speed to .20 to move it up.
    }
